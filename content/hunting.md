...
{{HuntingGuideSpot
  ...
  |monsters=[[Greater Plaguebone]], [[Plaguebone Skeleton]], [[Greater Scalebone]], [[Rotting skeleton]]
  |xpModifier= 100%
  |era=Kunark
  |for=MAG, SHD
  |image=[[File:Npc_greater_plague_skeleton.png|125px | center]]
  |notes=One of these skeletons can be pulled single, while the other two come together (but can be split once camp is broken).  Mix of blues/light blues at 54, with an extremely small chance of the [[Rotting skeleton]], who drops a piece of the [[Key to Veeshan's Peak]]. Respawn time is 6:30
}}
{{HuntingGuideSpot
  |soloLevel= 51-59
  |groupLevel= 49 - 59
  |zone=Nagafen's Lair | Nagafen's Lair (Sol B)
  |area= Near Sol A Zoneline
  |monsters= [[Lava duct crawler]]s
  |xpModifier= 100%
  |for=MAG,SHM
  |image=[[File:Npc lava duct crawler.png| 125px | center]]
  |notes= Good for Shaman/Monk duo and other combinations. Procs [[Boiling Blood]] during combat which blocks regen spells from being applied. It's possible to level to 60 from these but after 55-56 it becomes pretty slow exp. See also [[Kurrat's Lava Duct Crawler Guide for Magicians]].
}}
{{HuntingGuideSpot
  |soloLevel= 51-56
  |groupLevel= 51-56
  ...
  |era=Kunark
  |for=DRU, WIZ, MAG
|image=[[File:Npc_a_raptor.png |125px|center]]
  |notes= Can't bind in zone. Raptors run VERY fast (but slower than JBoots) and have a '''HUGE''' aggro/assist range. [[Pegasus Feather Cloak]] is recommended, as keeping levitate up at all times makes it possible to run.<br/>
...
{{HuntingGuideSpot
  ...
  |zone=City of Mist
  |area= 2nd Floor
  |monsters= Assorted, eg. [[a Haze Golem|Haze Golems]]
  |xpModifier= 113%
  |era=Kunark
  |for=ENC/SHM
  |notes=
...
{{HuntingGuideSpot
  ...
  |zone=Burning Woods
  |area= Giant Fort
  |monsters= [[A Forest Giant Verdant]], [[A Forest Giant Ancient]], etc.
  |xpModifier= 100%
  |era=Kunark
  |notes= Giants can drop [[Giant Foreman's Tunic]], [[Giant Lord's Tunic]], [[Forest Loop]], and weapons that vendor for 10-45 plat
}}
{{HuntingGuideSpot
  |soloLevel= 51-56
  |groupLevel= -
  |zone=Burning Woods
  |area= {{Loc|Burning Woods|4000, 1750}}, near [[Skyfire Mountains|Skyfire]] zoneline
  |monsters= [[A Sarnak Zealot]], [[A Forest Giant Ancient]], etc.
  |xpModifier= 100%
  |era=Kunark
  |notes= If giant fort is taken you can pull from the "field" just south of this hunting spot.  The field has various mobs (largely sarnaks) pathing through it, so sometimes its barren and other times its busy. If you bring your pull back towards the valley on the way to Skyfire you can avoid adds (and run to zone if needed).
}}
{{HuntingGuideSpot
  |soloLevel= 51-56
  |groupLevel= -
  |zone=Howling Stones | Howling Stones (Charasis)
  |area= Entrance
  |monsters= ?
  |xpModifier= 113%
  |era=Kunark
  |for=SHM
  |image=[[File:Charasis_Entry_Platform.jpg | 150px ]]
  |notes=
}}
{{HuntingGuideSpot
  |soloLevel= 51-57
  ...
  |area= Kelethin (Outside Rogue's Guild)
  |monsters= Kelethin Guards
  |xpModifier= 133%
  |for=MAGE, SHD, evil
  |notes= Lowers wood elf faction; guards drop fine steel weapons; quad-able ([http://www.project1999.com/forums/showthread.php?p=1617157#post1617163 tips here]); outside rogue's guild is a good spot to pull singles
}}
{{HuntingGuideSpot
  |soloLevel=  52-55
  |groupLevel= -
  |zone=Wakening Lands
  |area= {{Loc|Wakening Lands| 2800, 100| Easy 4x Goo Cave}} or {{Loc|Wakening Lands| -3000, -850| Harder Cave; more Goos}}
  |monsters= 4x [[A Tar Goo]]
  |xpModifier= 100%
  |era=Velious
  |for=BRD/MAG/SHD/SHM
  |image=[[File:Npc_a_tar_goo.png | 150px ]]
  |notes=Decent (but not great) loot of non-Velious gems.  The easy/4-goo cave spaces the goos apart, so no [[Harmony]] is needed, but the southern cave has goos next to each other, so you'll need it (or another way to deal with 2+ at once).  Because the goos are KOS to the adjacent geonids, if you haven't ruined your faction you can run to them for help.
}}
{{HuntingGuideSpot
  |soloLevel=  52-53
  |groupLevel= -
  |zone=Kedge Keep
  |area= ?
  |monsters= [[a spinereef seahorse]], [[a squallsurge seahorse]]
  |xpModifier= 217%
  |for=DRU
  |notes= Good for animal charming. Start in the far back, right-most room.  Charm the seahorse there, then wait for the pather to enter the room and use the two to kill each other, then repeat on other rooms, using Calm Animal to split three-seahorse room; always try and stay in a corner and gate out or [[Leatherfoot Raider Skullcap]] out at the first sign of trouble
}}
{{HuntingGuideSpot
  |soloLevel= 52-58(59)
  |groupLevel= -
  |zone=Great Divide
  |area= Along east wall, south of fort, eg. {{Loc|Great Divide|-4200, -3000}}
  |monsters= [[a frost giant elite]], [[Gorul Longshanks]]
  |xpModifier= 100%
  |era=Velious
  |for=MAG, SHM
  |image=[[File:Npc_a_frost_giant_elite.png|80px|center]]
  |notes=Being Velious, these giants have more HP than (say) Forest Giants in Burning Woods (Kunark), and so are slower XP.  However, they do still give some XP, and also give both [[Claws of Veeshan]] and [[Coldain]] faction.<br/><br/>

Start along west wall (either by the boulder south of fort, or even further south).  Park pet (if any), then run East to find Frost Giant Elites.  Bring them back to wall to avoid adds.  At 59 some elites turn light blue, but many remain blue.
}}
{{HuntingGuideSpot
  |soloLevel=  52-59
  |groupLevel= -
...
{{HuntingGuideSpot
  ...
  |area= Entrance/Moat
  |monsters= Various, eg. [[Skeletal guardian]]
  |xpModifier= 113%
  |era=Kunark
  |for=WAR
  |notes= Nearby LFG casters may buff/heal
}}
{{HuntingGuideSpot
  |soloLevel= 53-59
  |groupLevel= 55-59
  |zone=Howling Stones | Howling Stones (Charasis)
  |area= [[Charasis_Basement|Basement]]
  |monsters= ?
  |xpModifier= 113%
  |era=Kunark
  |for=ENC/NEC/SHM/SHD
  |image=[[File:Charasis_Basement.png | 150px | link=Charasis Basement]]
  |notes=See [[Charasis Basement]] for more info
}}
{{HuntingGuideSpot
  |soloLevel= 53-59
  |groupLevel= -
  ...
  |era=Kunark
  |for=SHM
  |notes= Requires [[Key to Sebilis Quest| key]]; unlike other dungeon entrances, there's no immediate exit so you might want to bind outside
}}
{{HuntingGuideSpot
  |soloLevel= 53-55
  |groupLevel= -
  |zone=Everfrost
  |area= Passage to plains
  |monsters= Barbarian guards
  |xpModifier= 133%
  |for=BRD/NEC/SHM, evil
  |notes=3 static spawns; lowers [[Merchants of Halas]], [[Shamen of Justice]], [[Steel Warriors]], and [[Wolves of the North]]
}}
{{HuntingGuideSpot
  |soloLevel= 53-?
  |groupLevel= -
  |zone= Neriak Third Gate
  |area= Temple of Innoruuk (#1)
  |monsters= Dark Elf Cleric Guards
  |xpModifier= 133%
  |for=
  |image=[[File:Npc_jabon_t%60kix.png|60px|center]]
  |notes= Cast complete heal, need to be able to interrupt. Respawn time is 6m40s and guards drop fine steel.
}}
{{HuntingGuideSpot
  |soloLevel= 54-56
  |groupLevel= 51-55
  |zone=Frontier Mountains
  |area= End of tunnel inside giant fort
  |monsters= [[Eldak Howlingbear]] and [[Mentrax Mountainbone]]
  |xpModifier= 100%
  |for=BRD, SHD
  |era=Velious
  |notes= These mobs are indifferent to all, have a 6 min respawn, drop no loot, and can be feared
}}
{{HuntingGuideSpot
  |soloLevel= -
  |groupLevel= 54-58
  |zone=Karnor's Castle
  |area= Left Courtyard ("LCY"), in front of #9
  |monsters= ?
  |xpModifier= 113%
  |era=Kunark
  |for=
...
{{HuntingGuideSpot
  ...
  |xpModifier= 217%
  |for=
  |notes= [[Enduring Breath]] required; 2 Piranha and Golden haired mermaid respawn every 22 min
}}
{{HuntingGuideSpot
  |soloLevel= 55-59
  |groupLevel= -
  ...
  |era=Kunark
  |for=
  |notes=The entrance to [[Chardok]] is ''not'' its exit, so be careful as there's a slight run if you need to zone
}}
{{HuntingGuideSpot
  |soloLevel= 55-60
  |groupLevel=
...
{{HuntingGuideSpot
  ...
  |zone= The Hole
  |area= Yael Pit
  |monsters= Elementals, Rat, Rock Golems
  |xpModifier= 200%
  |era=Hole
  |for=SHM/DRU/NEC
  |notes= Good for root rot on the Elementals and Rat spawns. Elementals sometimes spawn as Harvester (Cleric) which won't heal if nothing is in melee range or Wizards; both of these have nasty nukes, so buff up your resists or park them somewhere that you can line of sight their casting. Rock Golems can summon depending on level, only fight them if you can melee and survive (SHM with slow). 4 mobs in pit, more mobs up the ramp through the rock door. Watch out for [[Nortlav the Scalekeeper]] who is not KOS, but will social aggro Hole mobs. Watch out for [[Master Yael]] spawn timer so he doesn't kill you while grinding.
}}
{{HuntingGuideSpot
  |soloLevel= 55-59
  |groupLevel= -
  |zone=Skyfire
  |area= Near temple at south end, along west wall
  |monsters= ?
  |xpModifier= 107%
  |era=Kunark
  |for=
  |notes= Stay well up on the wall to avoid aggro from mobs pathing by. Be wary of aoe dispel spamming chromodracs. Elder mobs (and some others) will summon.
}}
{{HuntingGuideSpot
  |soloLevel= 55-59
  |groupLevel= -
  ...
  |era=Velious
  |for=DRU
  |notes= Extremely dangerous (harder than bear pits: wolves will instagib you if you make the slightest mistake); wolves are animal-charm-able with [[Call of Karana]], but only the ones that hit for a max of 242 or less
}}
{{HuntingGuideSpot
  |soloLevel= 55-59
  |groupLevel= -
...
{{HuntingGuideSpot
  ...
  |era=Velious
  |for=DRU/ENC/MNK
  |notes=Can charm McStinkles (others too, but Stink is the only animal that doesn't summon) and bring him down. Monk can solo at 58/59 depending on gear. Get to know the pathing rats or you're gonna have a bad time with adds.
}}
{{HuntingGuideSpot
  |soloLevel= -
  |groupLevel= 55-59
  ...
  |era=Velious
  |for=
  |notes= Harmony is necessary; if you find the sphinx at the center DO NOT tell it "No" or it will kill you; hedge wizards are the hardest. <~ Bad tip. Even with a liberal application of Harmony you will get a million adds.
}}
{{HuntingGuideSpot
  |soloLevel= -
  |groupLevel= 55-59
  |zone=Plane of Mischief
  |area= ?
  |monsters= audience at puppet show, [[Chuckles the Great]]
  |xpModifier= 140%
  |era=Velious
  |for=
...
{{HuntingGuideSpot
  ...
  |xpModifier= 217%
  |for=DRU
  |notes= Good for animal charming (fish, sharks, seahorses are charmable), [[Enduring Breath]] required, worn effect strongly encouraged. Remember your junk buffs as dang near everything dispels. Keep a dispel memorized because dang near everything has druid/ranger damage shields.
}}
{{HuntingGuideSpot
  |soloLevel= 56-59
  |groupLevel= -
...
{{HuntingGuideSpot
  ...
  |zone=Great Divide
  |area= ?
  |monsters= [[An expedition guard| Coldain Expedition Guard]]s
  |xpModifier= 100%
  |era=Velious
  |for=MAG/NEC
  |notes= Lowers Coldain faction, good for pet classes, but can be tough if under-geared
}}
{{HuntingGuideSpot
  |soloLevel= 56-59
  |groupLevel= -
  ...
  |xpModifier= 113%
  |era=Velious
  |notes= Lowers Frost Giant faction, slowers on the lower-end (level-wise) may have difficulty landing slows; XP is decent and there's a chance to get armor drops
}}
{{HuntingGuideSpot
  |soloLevel= 56-59
  |groupLevel= 55-59
  |zone=Permafrost
  |area= Polar bear pits
  |monsters= [[Giant Polar Bear]]s
  |xpModifier= 225%
  |for=DRU/RNG/SHM
  |image=[[File: Polar bear pit.jpg | 150px]]
  |notes=
}}
{{HuntingGuideSpot
  |soloLevel= 56-59
  |groupLevel= 55-59
  |zone=Nagafen's Lair|Nagafen's Lair (Sol B)
  |area= [[Nagafen's Lair Efreeti Room|Efreeti Room]] (#4)
  |monsters= [[Imp Protector|Imp Protectors]], [[Lava guardian|Lava Guardians]], etc.
  |xpModifier= 100%
  |for=SHM
  |image=[[File: Nagafen's Lair Stepping Stones.jpg | 150px]]
  |notes=[[Nagafen's Lair Efreeti Room| Further Details]]
}}
{{HuntingGuideSpot
  |soloLevel= 57-59
  |groupLevel= 57-59
  |zone=Lower Guk
  |area= between Magi and Ghoul Lord
  |monsters= ?
  |xpModifier= 100%
  |for=PAL/SHD
  |notes=
...
{{HuntingGuideSpot
  ...
  |zone=Siren's Grotto
  |area= Arena (#3)
  |monsters= Manatee and Walrus servants
  |xpModifier= 113%
  |era=Velious
  |for=DRU
  |notes= Good for charm-kiting; egress/succor to the other side from CS and work your way in; only do the enthralled stuff, swordfish, and possibly coldspine seahorses; good chance of drops
}}
{{HuntingGuideSpot
  |soloLevel= -
  |groupLevel= 58-59
  ...
  |era=Velious
  |for=
  |notes= Bring either a cleric or a torpor shaman for heals, enchanter/bard (enc preferred) for CC, monk for pulls, and tank. If you are missing one of those, don't do it.
}}
{{HuntingGuideSpot
  |soloLevel= 58-59
  |groupLevel= 56-59
  ...
  |era=Kunark
  |for=BRD, SHD
  |notes= Lowers [[Venril Sathir (Faction)]], requires [[Key to Charasis]] and [[Tallow-marked Candle]] (dropped by bottomless mobs)
}}
{{HuntingGuideSpot
  |soloLevel= 58-59
  |groupLevel= 57-59
  ...
  |era=Kunark
  |for=
  |notes= Lowers [[Venril Sathir (Faction)]], requires [[Key to Charasis]]
}}
{{HuntingGuideSpot
  |soloLevel= 59
  |groupLevel= 58-59
...
<nowiki>*</nowiki> All experience bonuses are per the [[Recommended Levels and ZEM List]], except that they've been converted in to percentages (with 75 ZEM = 100% of normal XP bonus).  These ZEMs are known to be out of date and inaccurate, but no better information exists.
